/*
 * Shell version 3 - to be used with 1.5mm base plate from sheet material.
 */
...
module side_outline() {
    ...
    polygon(
        [
            [-shell_d_half, baseplate_h],
            [-shell_d_half - rear_slope, shell_h],
            [shell_d_half - front_slope, shell_h],
            [shell_d_half - front_slope + 2, shell_h - 2],
            [shell_d_half - front_slope + 2, baseplate_h]
        ]
        );
}
